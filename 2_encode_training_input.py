...
with open('training_dataset.csv') as csv_file:
...
# get statistics
income_mean = np.mean(annual_income_list)
income_std = np.std(annual_income_list)
#bday_mean = np.mean(bday_list)
#bday_std = np.std(bday_list)
employee_days_mean = np.mean(employee_days_list)
employee_days_std = np.std(employee_days_list)

with open('statistics.csv', 'w', newline='') as csv_file:
    writer = csv.writer(csv_file)
    writer.writerows([
        ["income_mean","income_std","employee_days_mean","employee_days_std"],
        [income_mean, income_std, employee_days_mean, employee_days_std]
    ])
...
with open('encoded_training_dataset.csv', 'w', newline='') as csv_file:
    writer = csv.writer(csv_file)
